...
function PropertyDetailAdmin() {
    ...
    const fetchApi = async () => {
      try {
        ...
        if (res.code == 200) {
          ...
          if (newProperty.facilities) {
            newProperty.facilities = newProperty.facilities.map((item) => {
              return {
                value: item,
                label: item,
              };
          ...
          if (newProperty.rooms) {
            newProperty.rooms = newProperty.rooms.map((item) => {
              return {
          ...
          if (newProperty.roomTypes) {
            newProperty.roomTypes = newProperty.roomTypes.map((item) => {
              return {
                value: item.name,
                label: item.name,
              };
  ...
  return (
    <>
      ...
      {property && (
        <>
          <Form layout="vertical" style={{ maxWidth: 600 }} form={form}>
            <Form.Item
            ...
            <Row>
              <Col span={8}>
                <Form.Item label={<b>Điểm đánh giá</b>} name="avgReviewScore">
                  <InputNumber readOnly />
                </Form.Item>
              </Col>
              <Col span={8}>
                <Form.Item label={<b>Đánh giá sạch</b>} name="ratingClean">
                  <InputNumber readOnly />
                </Form.Item>
              </Col>
              <Col span={8}>
              ...
              <Col span={8}>
                <Form.Item label={<b>Đánh giá vị trí</b>} name="ratingLocation">
                  <InputNumber readOnly />
                </Form.Item>
              </Col>
              <Col span={8}>
                <Form.Item label={<b>Đánh giá nhân viên</b>} name="ratingStaff">
                  <InputNumber readOnly />
                </Form.Item>
              </Col>
              <Col span={8}>
                <Form.Item label={<b>Đánh giá wifi</b>} name="ratingWifi">
                  <InputNumber readOnly />
                </Form.Item>
              </Col>
              <Col span={8}>
                <Form.Item label={<b>Số lượng đánh giá</b>} name="numReviews">
                  <InputNumber readOnly />
                </Form.Item>
              </Col>
            </Row>
            ...
            <Form.Item label={<h3 style={{ color: "#0057B8" }}>Tiệc ích</h3>}>
              <Select
                options={property.facilities}
                defaultValue={property.facilities.length>0 ? property.facilities[0] : null}
              />
            </Form.Item>
            <Form.Item
            ...
            >
              <Select
                options={property.roomTypes}
                defaultValue={property.roomTypes[0]}
              />
            </Form.Item>
            <Form.Item
